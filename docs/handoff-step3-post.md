...
시안이 만든 "소제목이 없는 글이에요 / 대신 진행률로 위치를 알려드려요" 대체 카드는 **그대로 채택하되, 12편이 아니라 2편에만 나타납니다.** 41편 중 2편(4.9%)이면 예외 처리로 충분히 정당합니다.
...
**41편이 실제로 쓰는 인포스트링 전수 조사** (총 326개 펜스):
