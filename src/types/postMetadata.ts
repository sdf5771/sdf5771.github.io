export interface PostMetadata {
     ...
     *
     * ⚠️ 41편 중 16편이 `1`, 최댓값이 `20` 입니다(2026-08 실측). 명세 부록의
     *    `1분 17편 / 최대 18분` 은 낡은 수치입니다 — §5-1 의 산출 공식 자체는
     *    코드와 일치하므로 공식이 아니라 부록 표가 갱신되지 않은 것입니다.
     *    정보량이 낮으므로 메타 줄에서 3순위로 두고 배지·색으로 강조하지 마세요.
     */
